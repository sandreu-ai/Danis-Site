    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ref={ref}
          id={inputId}
          className={`w-full rounded-lg border bg-white px-4 py-3 text-base text-charcoal placeholder:text-charcoal-light/60 transition-colors min-h-[44px] font-sans
